...
class TestInvalidCurveGenerator(unittest.TestCase):
    def setUp(self):
        ...
        self.p = 0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff  # Prime number for finite field GF(p)
        self.a = 0xffffffff00000001000000000000000000000000fffffffffffffffffffffffc  # Coefficient a of the elliptic curve
    ...
    def test_invalid_curve_output(self):
        ...
        self.generator.generate_curves(target=15, g0=True, save_path=output_file)
